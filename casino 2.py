...
Si la suma de tus cartas es menor que 21, puedes 'plantarte' o 'pedir' otra carta.")
        ...
        while True:
            ...
            if blackjack():
                ...
                self.dinero += 1.5 * cantidad_apostada
            else:
    ...
    def jugar_poker(self):
        """ Permite al jugador jugar al Poker. """
        print("\n--- Poker ---")
        print("En desarrollo...")
    ...
    def jugar_dados(self):
        """ Permite al jugador jugar a los dados. """
        print("\n--- Dados ---")
        print("En desarrollo...")
    ...
    def jugar(self):
        ...
        while self.dinero > 0:
            ...
            print("\n1. Ruleta de Poker\n2. Blackjack\n3. Poker\n4. Tragamonedas\n5. Dados\n6. Salir")
            opcion = input("Elige el número del juego que quieres jugar (1-6): ")
        ...
        print(f"Has {'ganado' if self.dinero > dinero else 'perdido'} ${abs(dinero - self.dinero)}")
...
def main():
    ...
    dinero = Casino().obtener_cantidad("Ingresa la cantidad de dinero que quieres jugar: ")
